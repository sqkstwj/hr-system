...
//声明一个异步的函数
import { articleCategoryListService3, articleCategoryAddService3, articleCategoryUpdateService3, articleCategoryDeleteService3 } from '@/api/repun.js'
const articleCategoryList = async () => {
    let result = await articleCategoryListService3();
...
const addCategory = async () => {
    //调用接口
    let result = await articleCategoryAddService3(categoryModel.value);
...
const showDialog = (row) => {
    ...
    categoryModel1.value.details = row.details;
    categoryModel1.value.type = row.type;
...
const updateCategory = async () => {
    //调用接口
    let result = await articleCategoryUpdateService3(categoryModel1.value);
...
//     categoryModel1.value.details='';
//     categoryModel1.value.type='';
...
const deleteCategory = (row) => {
    ...
    ElMessageBox.confirm(
        ...
        .then(async () => {
            //调用接口
            let result = await articleCategoryDeleteService3(row.id);
            ElMessage({
                type: 'success',
                message: '删除成功',
            })
...
<template>
    <el-card class="page-container">
        ...
        <el-table :data="categorys" style="width: 100%">
            ...
            <el-table-column label="所在部门" prop="postName"></el-table-column>
            <el-table-column label="详情" prop="details"></el-table-column>
            <el-table-column label="奖惩类别" prop="type"></el-table-column>
        ...
        <el-dialog v-model="dialogVisible" :title="title" width="30%">
            <el-form :model="categoryModel" :rules="rules" label-width="100px" style="padding-right: 30px">
                ...
                <el-form-item label="员工姓名" prop="staffName">
                    <el-input v-model="categoryModel.staffName" minlength="1" maxlength="15"></el-input>
                </el-form-item>
                <el-form-item label="所在部门" prop="postName">
                    <el-input v-model="categoryModel.postName" minlength="1" maxlength="15"></el-input>
                </el-form-item>
                <el-form-item label="详情" prop="details">
                    <el-input v-model="categoryModel.details" minlength="1" maxlength="15"></el-input>
                </el-form-item>
                <el-form-item label="奖惩类别" prop="type">
        ...
        <el-dialog v-model="dialogVisible1" :title="title" width="30%">
            <el-form :model="categoryModel1" :rules="rules1" label-width="100px" style="padding-right: 30px">
                <el-form-item label="员工姓名" prop="staffName">
                    <el-input v-model="categoryModel1.staffName" minlength="1" maxlength="15"></el-input>
                </el-form-item>
                <el-form-item label="所在部门" prop="postName">
                    <el-input v-model="categoryModel1.postName" minlength="1" maxlength="15"></el-input>
                </el-form-item>
                <el-form-item label="详情" prop="details">
                    <el-input v-model="categoryModel1.details" minlength="1" maxlength="15"></el-input>
                </el-form-item>
                <el-form-item label="奖惩类别" prop="type">
                    <el-input v-model="categoryModel1.type" minlength="1" maxlength="15"></el-input>
                </el-form-item>
                <el-form-item label="执行时间" prop="time">
